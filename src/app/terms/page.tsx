            ...
            <div className="w-full lg:w-[35%] shrink-0">
              <div className="lg:sticky lg:top-32 space-y-8">
                <div className="bg-white dark:bg-white/5 border border-black/5 dark:border-white/10 p-8 shadow-sm">
                  <h3 className="text-xs uppercase tracking-wider font-black text-black/60 dark:text-white/60 mb-6 font-sans">Legal Snapshot</h3>
              ...
              <div className="bg-white dark:bg-[#121212] p-8 md:p-12 border border-black/5 dark:border-white/10 shadow-sm space-y-10">
                ...
                <section className="space-y-4">
                  <div className="flex items-center gap-3 text-black/60 dark:text-white/60">
                    ...
                    <h2 className="text-xs uppercase tracking-wider font-black font-sans">General Conditions & Service</h2>
                  </div>
                ...
                <section className="space-y-4">
                  <div className="flex items-center gap-3 text-black/60 dark:text-white/60">
                    ...
                    <h2 className="text-xs uppercase tracking-wider font-black font-sans">Artisan Integrity & Pricing</h2>
                  </div>
                  <div className="prose prose-sm dark:prose-invert text-black/70 dark:text-white/70 max-w-none leading-relaxed space-y-4 font-sans">
                    <p>
                ...
                <section className="space-y-4">
                  <div className="flex items-center gap-3 text-black/60 dark:text-white/60">
                    ...
                    <h2 className="text-xs uppercase tracking-wider font-black font-sans">Order Cancellations</h2>
                  </div>
                  <div className="prose prose-sm dark:prose-invert text-black/70 dark:text-white/70 max-w-none leading-relaxed space-y-4 font-sans">
                    <p>
                ...
                <section className="space-y-4">
                  <div className="flex items-center gap-3 text-black/60 dark:text-white/60">
                    ...
                    <h2 className="text-xs uppercase tracking-wider font-black font-sans">Intellectual Property & Trademarks</h2>
                  </div>
                  <div className="prose prose-sm dark:prose-invert text-black/70 dark:text-white/70 max-w-none leading-relaxed space-y-4 font-sans">
                    <p>
