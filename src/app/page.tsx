...
import { ArrowRight, ArrowLeft, Heart, ShieldCheck, Banknote, Star, Gem, Award, Globe, Leaf, Truck, X } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-background text-[#333333]">
      ...
      <main className="pt-[90px]"> {/* Optimized compact padding offset */}
        ...
        {/* 3. Visual Navigation: Category Section (Compact) */}
        ...
        {/* 3.5 Featured Collections: Full-Width Redesign (REFINED) */}
          ...
          >
            ...
            <div className="relative z-10 text-center text-white px-6">
              ...
              <motion.h2 
                ...
                className="text-5xl md:text-8xl lg:text-9xl font-serif italic mb-12 leading-[1.1] tracking-tight"
              >
                Sanganeri Flora
              </motion.h2>
              <motion.div
        ...
        {/* 5. Full-Width Product Section (3-4 per row) */}
        ...
        {/* 6. Premium Review Slider (Balanced Split Design) */}
