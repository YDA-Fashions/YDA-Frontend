...
import { MotionDiv, MotionH1, MotionP, MotionSection } from "@/components/common/ClientMotion";
      ...
      <main className="pt-20">
        ...
        <section className="py-24 md:py-44 container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <MotionDiv initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-100px" }} transition={{ duration: 0.8 }} className="relative aspect-[4/5] bg-border-beige overflow-hidden">
              <Image 
            ...
            <MotionDiv initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-100px" }} transition={{ duration: 0.8, delay: 0.2 }} className="max-w-md">
        ...
        <section className="py-24 md:py-44 container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <MotionDiv initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-100px" }} transition={{ duration: 0.8 }} className="lg:order-2 relative aspect-[4/5] bg-border-beige overflow-hidden">
              <Image 
            ...
            <MotionDiv initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-100px" }} transition={{ duration: 0.8, delay: 0.2 }} className="lg:order-1 lg:ml-auto max-w-md">
        ...
        <section className="bg-white py-24 md:py-44 border-t border-border-beige">
          <div className="container mx-auto px-6">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 h-[600px]">
                <MotionDiv initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-100px" }} transition={{ duration: 0.8 }} className="relative h-full overflow-hidden">
                  <Image src="/images/bags/tote/small/YDA-TB-001-beige-4.jpg" alt="Texture 1" fill className="object-cover" />
                </MotionDiv>
                <MotionDiv initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-100px" }} transition={{ duration: 0.8, delay: 0.1 }} className="relative h-full lg:mt-12 overflow-hidden">
                  <Image src="/images/bags/tote/small/YDA-TB-001-beige-6.jpg" alt="Texture 2" fill className="object-cover" />
                </MotionDiv>
                <MotionDiv initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-100px" }} transition={{ duration: 0.8, delay: 0.2 }} className="relative h-full overflow-hidden">
                  <Image src="/images/cushions/floral/YDA-CC-003-white-2.jpg" alt="Detail 1" fill className="object-cover" />
                </MotionDiv>
                <MotionDiv initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-100px" }} transition={{ duration: 0.8, delay: 0.3 }} className="relative h-full lg:mt-12 overflow-hidden">
        ...
        <section className="py-24 bg-[#FCFBFA]">
          <div className="container mx-auto px-6">
            <MotionDiv 
              ...
              className="mb-16"
            >
              <h2 className="text-3xl md:text-5xl font-serif italic mb-4">Shop the Selection</h2>
